      ...
      <section className="relative bg-adventum-terracota/30 py-20 md:py-32 border-b border-adventum-terracota">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 flex flex-col md:flex-row items-center gap-16 relative z-10">
          ...
          <div className="md:w-2/5 relative animate-float">
            ...
            {/* Contenedor NO cuadrado (Bordes asimétricos orgánicos) */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="max-w-xl mx-auto text-center mb-20">
              ...
              <p className="text-4xl md:text-5xl font-extrabold text-adventum-noche tracking-tighter">Tu Visado, sin estrés.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              {icon: '💼', title: 'Visado de Trabajo', desc: 'Permisos por cuenta ajena, propia o personal altamente cualificado.', delay: 0},
              {icon: '🎓', title: 'Visado de Estudiante', desc: 'Matrículas, prórrogas y autorización de trabajo para estudiantes.', delay: 200},
              {icon: '🌍', title: 'Nómadas Digitales', desc: 'Residencia para teletrabajadores internacionales con ley de startups.', delay: 400},
            ].map((service) => (
              <ScrollReveal key={service.title} delay={service.delay}>
                {/* Tarjetas muy redondeadas para evitar estilo cuadrado */}
